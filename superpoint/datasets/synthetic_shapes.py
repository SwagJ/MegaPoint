...
class SyntheticShapes(BaseDataset):
    ...
    def dump_primitive_data(self, primitive, tar_path, config):
        ...
        tf.print('Generating tarfile for primitive {}.'.format(primitive))
        ...
        tf.print('Tarfile dumped to {}.'.format(tar_path))
    ...
    def _init_dataset(self, **config):
        ...
        for primitive in primitives:
            ...
            # Untar locally
            tf.print('Extracting archive for primitive {}.'.format(primitive))
    ...
    def _get_data(self, filenames, split_name, **config):
        ...
        if config['cache_in_memory'] and not config['on-the-fly']:
            tf.print('Caching data, fist access will take some time.')
            data = data.cache()
